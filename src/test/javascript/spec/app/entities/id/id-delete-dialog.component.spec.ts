...
import { IdDeleteDialogComponent } from 'app/entities/id/id-delete-dialog.component';
import { IdService } from 'app/entities/id/id.service';

describe('Component Tests', () => {
  describe('Id Management Delete Component', () => {
    let comp: IdDeleteDialogComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(IdDeleteDialogComponent, '')
        .compileComponents();
